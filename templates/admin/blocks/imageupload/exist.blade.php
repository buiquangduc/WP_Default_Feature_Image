<div class="wrapper-upload form-group row item-type image-upload-row">
	...
	<div class="wrapper-image">
		...
		<input type="hidden" name="sections[{{ $section_index }}][image_id]" value="{{ $image_id }}" class="image-input-id">
		<input type="hidden" name="sections[{{ $section_index }}][image_source]" value="{{ $image_source }}" class="image-input-source">
	</div>
	<div class="col-sm-9">
